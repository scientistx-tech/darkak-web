        ...
        >
          ...
          >
            {isLoading ? (
              ...
              <FaHeart name={`wishlist-product-${slug}`} />
            )}
          </div>

          {/* View Product */}
          <Link href={`/product/${slug}`}>
            <FaEye name={`view-product-${slug}`} className="cursor-pointer transition-all duration-300 hover:scale-110 hover:text-secondaryBlue" />
          </Link>
          ...
          >
            <FaRandom name={`share-product-${slug}`} className="cursor-pointer transition-all duration-300 hover:scale-110 hover:text-secondaryBlue" />
              ...
              {showShare && (
                ...
                >
                  ...
                  >
                    <FaFacebook name={`facebook-product-${slug}`} className="text-white text-lg hover:scale-125 transition-transform" />
                  </Link>
                  ...
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <FaPinterest name={`pin-product-${slug}`} className="text-white text-lg hover:scale-125 transition-transform" />
                  </Link>
                  ...
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <FaXTwitter name={`twitter-product-${slug}`} className="text-white text-lg hover:scale-125 transition-transform" />
                  </Link>
