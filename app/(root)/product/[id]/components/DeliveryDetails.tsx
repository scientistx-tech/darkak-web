  ...
  const items = [
    {
      ...
      desc: `${lang === 'bn' ? 'পৌঁছাবে' : 'Arrives in'} ${deliveryInfo.delivery_time} ${lang === 'bn' ? 'কর্মদিবসের মধ্যে' : 'business days'
        }`,
    },
    {
      icon: <FaShippingFast />,
    ...
    },
    {
      ...
      desc: `${lang === 'bn' ? 'পৌঁছাবে' : 'Arrives in'} ${deliveryInfo.delivery_time_outside
    ...
    },
    {
      ...
      desc: `${lang === 'bn' ? 'ফ্রি রিটার্ন' : 'Free returns within'} ${deliveryInfo.return_days
